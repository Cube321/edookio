        ...
        if(!user && demoCardsSeen > 5){
            ...
            <div class="card-body flip-card-front pb-0 px-0">
                ...
                <div class="col-12 d-flex flex-column justify-content-center align-items-center ">
                    ...
                    <p class="demo-finished-text text-center text-smaller text-muted mt-3 mb-4">Teď už víš, jak InLege funguje. Vytvoř si účet a získej přístup k dalším <b>téměř 1 500 kartičkám</b>. Je to zdarma!</p>
