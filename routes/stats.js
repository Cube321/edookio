...
router.get(
  ...
  catchAsync(async (req, res) => {
    ...
    if (!show || show === "month") {
      ...
      data.premiumDeactivationsPerDay =
        data.premiumDeactivationsPerDay.slice(-31);
      data.premiumProlongationsPerDay =
        data.premiumProlongationsPerDay.slice(-31);
      data.registrationsPerDayBySource =
        data.registrationsPerDayBySource.slice(-31);
    }
    ...
    if (show === "quarter") {
      ...
      data.premiumDeactivationsPerDay =
        data.premiumDeactivationsPerDay.slice(-90);
      data.premiumProlongationsPerDay =
        data.premiumProlongationsPerDay.slice(-90);
      data.registrationsPerDayBySource =
        data.registrationsPerDayBySource.slice(-90);
    }
    ...
    if (show === "halfyear") {
      ...
      data.premiumDeactivationsPerDay =
        data.premiumDeactivationsPerDay.slice(-180);
      data.premiumProlongationsPerDay =
        data.premiumProlongationsPerDay.slice(-180);
      data.registrationsPerDayBySource =
        data.registrationsPerDayBySource.slice(-180);
    }
